...
local title=display.newText("From the smallest to the biggest, touch numbers,\n according on their size", 50, 20, native.systemFont, 14 ) -- почему не отображает русс яз.???
