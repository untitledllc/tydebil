...
local title=display.newText("You are very close to finish", 50, 20, native.systemFont, 14) 
...
local title2=display.newText("Now not time to be mistaken", 50, 20, native.systemFont, 14 ) 
...
local title3=display.newText("Only continue to read.", 50, 20, native.systemFont, 14 ) 
...
local title4=display.newText("Time run.", 50, 20, native.systemFont, 14 ) 
...
local title5=display.newText("You have spent for nothing a minimum of 5 seconds, reading it.", 50, 20, native.systemFont, 14 ) 
...
local title6=display.newText("Break small ", 50, 20, native.systemFont, 14 ) 
...
local title7=display.newText(" for continuation", 50, 20, native.systemFont, 14 ) 
...
if event.phase=="ended" then 
   ...
   if (event.x - duck3.x)^2 + (event.y - duck3.y)^2 <= duck3.contentHeight^2/4
	 then
   director:changeScene("s1r5check")
