...
buttonred.y=math.random(title.y+title.contentWidth/2,  display.contentHeight/2 +display.viewableContentHeight/2 - buttonred.contentWidth/2)
...
buttonblue.y=math.random(title.y+title.contentWidth/2,  display.contentHeight/2 +display.viewableContentHeight/2 - buttonblue.contentWidth/2)
...
buttongreen.y=math.random(title.y+title.contentWidth/2, display.contentHeight/2 +display.viewableContentHeight/2 - buttongreen.contentWidth/2)
...
buttonorange.y=math.random(title.y+title.contentWidth/2, display.contentHeight/2 +display.viewableContentHeight/2 - buttonorange.contentWidth/2)
